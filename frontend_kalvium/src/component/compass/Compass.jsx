...
import '../../component/compass/compass.css'
  ...
  return (
    ...
    {/* <hr/> */}
     <div id="loader-container">
        {/* <!-- <img src="./Bg-for-why-to-edit-1.png" alt="" class="bg-for"> --> */}
        <div class="loader-part1 ">
            <h1 className ="text-start">Kalvium UG Program In CSE Is Powered By H.E.R.O.S</h1>
           <Link to="/heros"> <p>Learn More About HEROS &nbsp; <i class="fa-solid fa-arrow-right" style={{color: 'red'}}></i></p></Link>
        </div>
        <div class="loader-part2" style={{width:'30%'}}>
            <svg class="pl" viewBox="0 0 210 210" width="160px" height="160px" xmlns="http://www.w3.org/2000/svg">
                <defs>

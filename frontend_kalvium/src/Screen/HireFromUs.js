...
import { useStyles } from "../Screen/HireFromUsCss";
export default function HireFromUs(props) {
        ...
        <div style={{ height: "100%" }}>
            ...
            <div className={classes.mainContainer}>
                ...
                <div className={classes.hireText1}>
                    Equipped with skills requi#ffcccc for the workplace, our students are #OpenToWork and we believe they’d make a great fit at any
                </div>
                <div className={classes.hireText2}>
                    organisation. If you’re hiring for your team, let’s connect!
                </div>
                <div className={classes.buttonContainer}  onClick={()=>handleSubmit()}>
                    <button  className={classes.button} role="button">Lets Talk!</button>
                </div>
            </div>
